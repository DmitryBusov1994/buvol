  ...
  const form = (
    <form className={formClassName}>
      <label className="materialize grid gap-1.5 rounded-xl p-0.5">
        <span className={compact ? "text-[11px] font-medium text-ink/70" : "text-xs font-medium text-ink/70"}>
          {c.nameLabel}
        </span>
        <input
          name="name"
          autoComplete="name"
          className={[
            "w-full rounded-xl border border-black/10 bg-white px-3 text-sm outline-none transition focus:border-brand-amber/60 focus:ring-2 focus:ring-brand-amber/20",
      ...
      <label className="materialize grid gap-1.5 rounded-xl p-0.5">
        ...
        <textarea
          name="message"
          className={[
            "w-full resize-y rounded-xl border border-black/10 bg-white px-3 py-2 text-sm outline-none transition focus:border-brand-amber/60 focus:ring-2 focus:ring-brand-amber/20",
            compact ? "min-h-[5.5rem]" : "min-h-28 px-4 py-3 rounded-2xl",
          ].join(" ")}
      ...
      <button
        ...
        className={[
          ...
          compact ? "mt-1 h-10 px-4" : "mt-2 h-12 rounded-2xl px-6 hover:scale-[1.03]",
        ].join(" ")}
      >
        {c.submit}
      </button>
